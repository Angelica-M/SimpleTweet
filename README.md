...
- [ ] User can attach one or more images when they are composing a tweet

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://github.com/Angelica-M/SimpleTweet/blob/master/simpleTweetDemo1.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
<img src='https://github.com/Angelica-M/SimpleTweet/blob/master/simpleTweetDemo2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

No challenges were faced. The Parceler Library was used to wrap User and Tweet class(es) so they could be stored in a local SQL database. See https://guides.codepath.org/android/Using-Parceler. 
...
<img src='https://github.com/Angelica-M/SimpleTweet/blob/master/simpleTweetDemo0.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
